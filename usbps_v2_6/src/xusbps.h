// Modified by Bowie Gian to add Host Mode,
// referencing the provided code
...
/**
 * The following APPENDED data structure represents queue head. ~~~~~~~~~~~~~~~~~~~~~
 */
typedef struct {
	XUsbPs_pQH	*pQH;
...
/**
 * The APPENDED XUsbPs_HostConfig structure contains the configuration information to
...
typedef struct {
	...
	XUsbPs_HostConfig	HostConfig;
					/**< APPENDED Configuration for the HOST mode. */
...
// APPENDED ~~~~~~~~~~~
int XUsbPs_QHQueueRequest(XUsbPs *InstancePtr, u8 QHNum,
